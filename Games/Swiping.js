...
function getCookie(cname) {
  ...
  #vl_likeCard_content_fixed{position: fixed; top: 50%; left: 50%; opacity: 1; z-index: 100000004; webkit-transform: translate(-50%, -50%); transform: translate(-50%, -50%);}
  ...
  function vlLikeCard(){
    ...
    popbox.append(vl_card_like);
      ...
      cls_btn.src="https://imgvisilabsnet.azureedge.net/banner/uploaded_images/244_1239_20220114152553839.png";
  ...
  // vl.AddParameter("OM.TargetName","LikeCard-2022");
  // vl.AddParameter("OM.ProductType",useEventAttr);
  // vl.AddParameter("OM.SlideType","LOVE");
   document.cookie = "ProductType="+useEventAttr+"; expires=Thu, 18 Dec 2023 12:00:00 UTC";
   SecondSettingsPopup(useEventAttr);
  // vl.Collect();
  // vl.SuggestActions();
  // ga("create", "UA-31147745-2", {name: "RMC", cookieDomain: "auto"});
  // ga('RMC.send', 'event', 'RMC', useEventAttr, "LOVE", {nonInteraction: true});
    ...
    // vl.AddParameter("OM.TargetName","LikeCard-2022");
    // vl.AddParameter("OM.ProductType",useEventAttr);
    // vl.AddParameter("OM.SlideType","NOPE");
    // vl.Collect();
  
    // ga("create", "UA-31147745-2", {name: "RMC", cookieDomain: "auto"});
    // ga('RMC.send', 'event', 'RMC', useEventAttr, "NOPE", {nonInteraction: true});
  ...
  if(slidetotal==4){
    ...
    if(controlCookie=="allnope"){
      // var vl = new Visilabs();
      // vl.AddParameter("OM.LastCodeView","AllNope");
      // vl.SuggestActions();  
      //var sendNope="allnope";
      //SecondSettingsPopup(sendNope);
    }
  ...
  function SecondSettingsPopup(imagetype) {
    ...
    switch (imagetype) {
        case "rare":
        image="https://imgvisilabsnet.azureedge.net/banner/uploaded_images/244_1240_20220202141844911.gif";
        code="Rare";
      break;
        case "avokado":
        image="https://imgvisilabsnet.azureedge.net/banner/uploaded_images/244_1240_20220202141806945.gif";
        code="Avokado";
      break;
        case "midnight":
        image="https://imgvisilabsnet.azureedge.net/banner/uploaded_images/244_1240_20220202141827894.gif";
        code="Midnight";
      break;
        case "ultra":
        image="https://imgvisilabsnet.azureedge.net/banner/uploaded_images/244_1240_20220202141900730.gif";
        code="Ultra";
      break;
...
//var imagetype=getCookie("ProductType");
...
function LikeCardChoosePopup(width, height, mWidth, mHeight, img, code ) {
    if (!document.querySelector(".vl-ChoosePopup-container")) {
        ...
        .vl-ChoosePopup{position:absolute;z-index:100001;width:${width};height:${height};left: 50%;top: 50%;transform: translate(-50%,-50%);-webkit-transform: translate(-50%,-50%);}
    ...
    `;
        ...
        <img class="vl-ChoosePopup-close" src="https://img.visilabs.net/banner/uploaded_images/323_1326_20210127153709279.png">
        </div>
    `;
        ...
        function runcodepopup(){
            ...
            document.querySelector(".vl-ChoosePopup-container").remove();
            // ga("create", "UA-31147745-2", {name: "RMC", cookieDomain: "auto"});
            // ga('RMC.send', 'event', 'RMC', "LikeCard-2022", imagetype+"-GetCode", {nonInteraction: true});
            // var vl = new Visilabs();
            // vl.AddParameter("OM.TargetName","LikeCard-2022");
            // vl.AddParameter("OM.LastCodeView",imagetype);
            // vl.Collect();
            // vl.SuggestActions();
        }
